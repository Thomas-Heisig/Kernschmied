...
9. [-] Frontend-Einstieg und Providerstruktur konsolidieren.
10. [ ] Bootstrap-Vertrag im Frontend ergänzen.
11. [ ] Bootstrap zuerst laden.
12. [ ] Endpoint-Auflösung zentralisieren.
13. [ ] Store um Bootstrap, Capabilities, Versionen und Revisionen erweitern.
14. [ ] Hart codierte Fachendpunkte entfernen.
15. [ ] StrictMode-sichere Initialisierung gewährleisten.

## Phase C – Hierarchie und SchemaRenderer

16. [-] Generischen Baum weiterverwenden und vervollständigen.
17. [ ] Hierarchie-Endpunkt vollständig implementieren.
18. [ ] Hierarchie-Frontendvertrag abgleichen.
19. [-] UI-Schema-Normalisierung vervollständigen.
20. [ ] UI-Schema-Endpunkt vollständig implementieren.
21. [ ] Komponenten-Registry finalisieren.
22. [-] Zentralen `SchemaRenderer` vollständig anbinden.
23. [-] Knotentyp `user` auf schema-gesteuerte Darstellung umstellen.
24. [ ] Weitere Platzhalter schrittweise ersetzen.

## Phase D – Modelle, Tools und Chat

25. [-] Modell- und Tool-Registries stabilisieren.
26. [ ] Manifestvalidierung und Fehlerisolierung testen.
27. [ ] Modellverträge und `ModelSelector` ergänzen.
28. [ ] Toolverträge und `ToolSelector` ergänzen.
29. [ ] `ChatRequest` vollständig anbinden.
30. [ ] SSE-Vertrag stabilisieren.
31. [ ] Chatstream robust testen.

## Phase E – Konfiguration, Revisionen und Sicherheit

32. [ ] Config-Revisionen atomar anbinden.
33. [ ] Registry-Revisionen anbinden.
34. [ ] Zielgerichtete Cache-Invalidierung implementieren.
35. [ ] Autorisierung vollständig prüfen.
36. [ ] Audit-Logging prüfen.
37. [ ] Betriebsprofile absichern.
38. [ ] Request-ID und strukturierte Fehler vollständig integrieren.

## Phase F – Abschluss

39. [ ] Backend-Unit-Tests vervollständigen.
40. [ ] Frontend-Unit-Tests ergänzen.
41. [ ] Integrationstests ausführen.
42. [ ] `npm run build` erfolgreich ausführen.
43. [ ] Backendtests erfolgreich ausführen.
44. [ ] OpenAPI-Diff prüfen.
45. [-] README und Projektdokumentation aktualisieren.
46. [ ] Gemeinsamen Start über `start.ps1` prüfen.
47. [ ] MVP-Abnahmekriterien vollständig dokumentieren und abnehmen.
