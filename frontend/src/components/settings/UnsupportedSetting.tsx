...
export default function UnsupportedSetting({ entry, path }: { entry: ConfigEntryResponse; path: string[] }) {
  ...
  return (
    <SettingsInputContainer fieldId={fieldId} fieldKey={entry.full_key} label={entry.display_name}>
      <p className="text-sm text-slate-500">Komponenten vom Typ "{entry.ui.component}" werden derzeit nicht unterstützt.</p>
