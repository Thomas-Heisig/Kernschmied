...
import inferFieldMetadata from './settingsFieldUtils';
...
// `SettingsSearch` extracted to its own file to reduce SettingsContent size.
...
// `SettingsJsonEditor` was extracted to a dedicated file to reduce file size.
